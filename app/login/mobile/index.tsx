...
const MobileLogin = () => {
    ...
    const renderStep = () => {
        switch (currentStep) {
            case 1:
                return <Screen1 selectedValue={countryCode} setSelectedValue={setCountryCode} isBtnDisabaled={isBtnDisabaled} setMobileNumber={setMobileNumber} setIsButtonDisabled={setIsButtonDisabled} buttonAction={handleSendOtp} />;
            case 2:
                return <Screen2 mobileNumber={mobileNumber} countryCode={countryCode} isBtnDisabaled={otpbuttonDisable} mobileOtp={otp} setMobileOtp={setOtp} />;
            case 3:
